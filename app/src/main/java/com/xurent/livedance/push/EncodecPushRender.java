...
public class EncodecPushRender implements EGLSurfaceView.GLRender {
    ...
    public void setWatermark(String watermark) {
        bitmap = ShaderUtil.createTextImage("LiveDance "+watermark, 50, "#DCDCDC", "#00000000", 1);
        AddWater(bitmap);
    }
    ...
    public EncodecPushRender(Context context, int textureid) {
        ...
        bitmap = ShaderUtil.createTextImage("LiveDance ", 50, "#DCDCDC", "#00000000", 1);
        AddWater(bitmap);
    ...
    private void AddWater(Bitmap bitmap){
