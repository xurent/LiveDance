...
RtmpPush::RtmpPush(const char *url,PushCallJava *wlCallJava) {
...
void *callBackPush(void *data){
    ...
    rtmpPush->wlCallJava->onConnectint(CHILD_THRBAD);
...
void RtmpPush::pushData(char *data, int data_len,bool keyframe) {
